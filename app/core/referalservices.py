...
#         return  # User has no purchased level yet
    
#     purchased_amount = purchased_level.salary  # use salary or earnest_money depending on your rules
